...
const DEMO_BRANDS = ['Apple', 'Samsung', 'Xiaomi', 'OPPO', 'Sony', 'Nokia', 'Infinix', 'Realme', 'Huawei', 'iPad', 'Honor', 'Teclast', 'MacBook', 'ASUS', 'Lenovo', 'DELL', 'HP', 'ACER', 'LG', 'MSI', 'TOSHIBA', 'AQUA'];
...
const DEMO_PRODUCTS = [
  {
    ...
    variants: [
      { color: 'Titan tự nhiên', storage: '256GB', price: 34990000, originalPrice: 37990000, stock: 12, image: 'https://placehold.co/800x800/1a1a2e/ffffff?text=iPhone+16+Pro+Max' },
      { color: 'Titan đen', storage: '512GB', price: 39990000, originalPrice: 42990000, stock: 8, image: 'https://placehold.co/800x800/1a1a2e/ffffff?text=iPhone+16+Pro+Max' },
    ],
    images: [
      'https://placehold.co/800x800/1a1a2e/ffffff?text=iPhone+16+Pro+Max',
      'https://placehold.co/800x800/111827/ffffff?text=Camera+Pro',
    ],
    image: 'https://placehold.co/800x800/1a1a2e/ffffff?text=iPhone+16+Pro+Max',
    isFeatured: true,
    isOnSale: true,
    isHot: true,
  },
  {
    ...
    variants: [
      { color: 'Đen', storage: '256GB', price: 31990000, originalPrice: 34990000, stock: 10, image: 'https://placehold.co/800x800/0f172a/ffffff?text=Galaxy+S25+Ultra' },
      { color: 'Xanh', storage: '512GB', price: 35990000, originalPrice: 38990000, stock: 7, image: 'https://placehold.co/800x800/0f172a/ffffff?text=Galaxy+S25+Ultra' },
    ],
    images: [
      'https://placehold.co/800x800/0f172a/ffffff?text=Galaxy+S25+Ultra',
      'https://placehold.co/800x800/1f2937/ffffff?text=S+Pen',
    ],
    image: 'https://placehold.co/800x800/0f172a/ffffff?text=Galaxy+S25+Ultra',
    isFeatured: true,
    isOnSale: true,
    isHot: true,
  },
  ...
  catalogPromise = (async () => {
    try {
      ...
      if (!categories.length || !brands.length || !products.length) {
        console.warn('Catalog API returned empty data, using demo data.');
